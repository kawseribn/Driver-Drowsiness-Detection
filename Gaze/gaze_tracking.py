# -*- coding: utf-8 -*-
"""
Created on Fri Jun 12 20:38:35 2020
...
class GazeTracking(object):
    ...
    def is_center(self):
        ...
        if self.pupils_located:
            return self.is_right() is not True and self.is_left() is not True and self.is_up() is not True and self.is_blinking() is not True
    #def is_down(self):
     #   if self.pupils_located:
    ...
    def is_blinking(self):
        """Returns true if the user closes his eyes"""
            ...
            #return blinking_ratio > 10
        if self.pupils_located:
            return self.vertical_ratio() >= 0.85
    def lower_right(self):
        if self.pupils_located:
            a = self.horizontal_ratio() <= 0.45
            b = self.vertical_ratio() >= 0.85
            return ((a and b) == True)
    def lower_left(self):
        if self.pupils_located:
            a = self.horizontal_ratio() >= 0.65
            b = self.vertical_ratio() >= 0.85
            return ((a and b) == True)
